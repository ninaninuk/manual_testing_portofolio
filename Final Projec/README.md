...
Created a database named 'orange hrm' and a table named 'languages' with all the columns needed to save data per specifications. Performed different queries inside the sql file:[linguages.sql](https://github.com/ninaninuk/manual_testing_portofolio/blob/6df41ed1864356724a7c8b45341ea2aa83a3adf4/Final%20Projec/orange%20hrm.sql)
